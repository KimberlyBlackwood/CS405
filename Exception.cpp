...
#include <iostream>
#include <stdexcept> // Include this for std::domain_error

class MyCustomException : public std::exception {
  public:
    consnt char* what() const noexcept ovveride{
      
     return "Custom exception occured" << std::endl; 
    }
...
bool do_even_more_custom_application_logic()
{
  ...
  throw std::runtime_error("Error occured in Even Nore Custom Application Logic"); 
...
void do_custom_application_logic()
{
  ...
  if(do_even_more_custom_application_logic())
  {
    ...
    std::cout << "Exception caught in Custom Application Logic: " << e.what() << std::endl;
  }    
